...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="card">
			...
			<form id="form-filterx" class="form-horizontal">

                            <label class="control-label col-md-3">Pilih Flag</label>
                            <div class="col-md-4">
                                <select id="FLAG_PERMOHONAN" class="form-control">
                    ...
                    <div class="form-group">
                        <label for="LastName" class="col-sm-10 control-label"></label>
                        <div class="col-sm-10">
                            <button type="button" id="btn-filterx" class="btn btn-primary">Filter</button>
                            <button type="button" id="btn-resetx1" class="btn btn-default">Reset</button>
                        </div>
                    </div>
    ...
    <div class="col-md-9">
        <div class="card">
            <div class="card-header">
                ...
                <h4 class="card-title mb-0"> DATA Penerimaan Jambong</h4>
            </div>
            <div class="card-body ">
                <div class="table-responsive no-wrap">
                    <table class="table table-bordered table-striped nowrap display" width="80%" cellspacing="0" id="tablejambongper">
                        <thead>
                            <tr>
							<th class="border-0 text-center">NO FORMULIR</th>
                                <th class="border-0 text-center">NAMA WP</th>            
								<th class="border-0 text-center">JAMBONG</th> 
								<th class="border-0 text-center">TGL PEMBAYARAN</th>
								<th class="border-0 text-center">ISI REKLAME</th>
								<th class="border-0 text-center">FLAG_PERMOHONAN</th>
                            </tr>
                        </thead>
                        <tbody>
                        </tbody>
...
<script>
  ...
  $('.shawCalRanges').daterangepicker({
	...
	function reload_table() {
        viewjb1.ajax.reload(null, false); //reload datatable ajax 
    }
...
<script type="text/javascript">
  var viewjb1;
    ...
    $(document).ready(function() {
        ...
        //datatables
        var viewjb1 = $('#tablejambongper').DataTable({
           ...
           "lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],
            ...
            "ajax": {
                "url": "<?php echo site_url('Jambong_permanen/jambong_per') ?>",
                "type": "POST",
               "data": function(data) {
				data.FLAG_PERMOHONAN = $('#FLAG_PERMOHONAN').val();
		...
		$('#btn-filter').click(function() { //button filter event click
            viewjb1.ajax.reload(); //just reload table
        });
