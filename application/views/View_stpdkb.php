    ...
    <div class="col-md-9">
        <div class="card">
            <div class="card-header">
                ...
                <h4 class="card-title mb-0"> DATA STPDKB</h4>
            </div>
            <div class="card-body ">
                <div class="table-responsive no-wrap">
                    <table class="table table-bordered table-striped nowrap display" width="80%" cellspacing="0" id="table_stpdkb">
                        <thead>
                            <tr>
                                ...
                                <th class="border-0 text-center">POKOK PAJAK</th>
                                <th class="border-0 text-center">BUNGA</th>
                                <th class="border-0 text-center">SANKSI</th>
								<th class="border-0 text-center">SANKSI PERSEN</th>
								<th class="border-0 text-center">BUNGA PERSEN</th>
								<th class="border-0 text-center">TOTAL PAJAK</th>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //datatables
tabel_stpdkb = $('#table_stpdkb').DataTable({
        ...
        $('#btn-filter').click(function() { //button filter event click
            tabel_stpdkb.ajax.reload(); //just reload table
        });
    ...
    function edit_person(NO_STPDKB)
{
    save_method = 'update';
    ...
    $.ajax({
        url : "<?php echo site_url('Stpdkb/edit/')?>/" + NO_STPDKB,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
 
            $('[name="NO_STPDKB"]').val(data.NO_STPDKB);
            $('[name="NO_FORMULIR"]').val(data.NO_FORMULIR);
            $('[name="POKOK_PAJAK"]').val(data.POKOK_PAJAK);
            $('[name="SANKSI"]').val(data.SANKSI);
			$('[name="BUNGA"]').val(data.BUNGA);
			$('[name="SANKSI_PERSEN"]').val(data.SANKSI_PERSEN);
			$('[name="BUNGA_PERSEN"]').val(data.BUNGA_PERSEN);
			$('[name="TOTAL_PAJAK"]').val(data.TOTAL_PAJAK);
            $('[name="KETERANGAN"]').val(data.KETERANGAN);
            $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
            $('.modal-title').text('Edit Stpd'); // Set title to Bootstrap modal title
...
{
    tabel_stpdkb.ajax.reload(null,false); //reload datatable ajax 
}
...
function save()
{
    ...
    if(save_method == 'add') {
        ...
        url = "<?php echo site_url('Stpdkb/update')?>";
    }
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Stpdkb Form</h3>
            </div>
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    <input type="hidden" value="" name="NO_STPDKB"/> 
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">POKOK PAJAK</label>
                            <div class="col-md-9">
                                <input name="POKOK_PAJAK" placeholder="NILAI DENDA PAJAK" class="form-control" readonly>
                                <span class="help-block"></span>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3">SANKSI</label>
                            <div class="col-md-9">
                                <input name="SANKSI" placeholder="SANKSI" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
							<div class="form-group">
                            <label class="control-label col-md-3">BUNGA</label>
                            <div class="col-md-9">
                                <input name="BUNGA" placeholder="BUNGA" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
							<div class="form-group">
                            <label class="control-label col-md-3">BUNGA PERSEN</label><i class="fa fa-percent"></i>
                            <div class="col-md-4">
                                <input name="BUNGA_PERSEN" placeholder="BUNGA_PERSEN" class="form-control" type="number">							
                                <span class="help-block"></span>
                            </div>
							<div class="form-group">
                            <label class="control-label col-md-3">SANKSI PERSEN</label><i class="fa fa-percent"></i>
                            <div class="col-md-4">
                                <input name="SANKSI_PERSEN" placeholder="SANKSI_PERSEN" class="form-control" type="number">
                                <span class="help-block"></span>
                            </div>
							<div class="form-group">
                            <label class="control-label col-md-3">TOTAL PAJAK</label>
                            <div class="col-md-9">
                                <input name="TOTAL_PAJAK" placeholder="TOTAL_PAJAK" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                            <div class="form-group">
