    ...
    <div class="col-md-9">
        <div class="card">
            <div class="card-header">
                ...
                <h4 class="card-title mb-0"> DATA Penerimaan Jambong Insidentil</h4>
            </div>
            <div class="card-body ">
                <div class="table-responsive no-wrap">
                    <table class="table table-bordered table-striped nowrap display" width="80%" cellspacing="0" id="tablejambongins">
                        <thead>
                            <tr>
...
<script>
  ...
  $('.shawCalRanges').daterangepicker({
	...
	function reload_table() {
        viewjb2.ajax.reload(null, false); //reload datatable ajax 
    }
...
<script type="text/javascript">
  var viewjb2;
    ...
    $(document).ready(function() {
        ...
        //datatables
        var viewjb2 = $('#tablejambongins').DataTable({
           ...
           "lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],
            ...
            "ajax": {
                "url": "<?php echo site_url('Jambong_insidentil/jambong_ins') ?>",
                "type": "POST",
               "data": function(data) {
		...
		$('#btn-filter').click(function() { //button filter event click
            viewjb2.ajax.reload(); //just reload table
        });
