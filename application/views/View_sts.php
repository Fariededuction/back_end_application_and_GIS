    ...
    <div class="col-md-9">
        <div class="card">
            <div class="card-header">
                ...
                <h4 class="card-title mb-0"> DATA STS OPS</h4>
            </div>
            <div class="card-body ">
                <div class="table-responsive no-wrap">
                    <table class="table table-bordered table-striped nowrap display" width="80%" cellspacing="0" id="table-sts">
                        <thead>
                            <tr>                           
                                <th class="border-0 text-center">JUMLAH OBYEK</th>
                                <th class="border-0 text-center">TGL PERMOHONAN</th>
                                <th class="border-0 text-center">PAJAK POKOK</th>                                 
                                <th class="border-0 text-center">DETAIL</th>
								<th class="border-0 text-center">CETAK</th>
...
$('.shawCalRanges').daterangepicker({
  ...
  function reload_table() {
	  viewqr.ajax.reload(null, false); //reload datatable ajax 
  }
</script>
...
viewsts = $('#table-sts').DataTable({
            ...
            "ajax": {
                "url": baseurl+"Cetak_bkp/cetak_bkp",
                "type": "POST",
        ...
        $('#btn-filter').click(function() { //button filter event click
            viewsts.ajax.reload(); //just reload table
        });
    ...
    function edit_person1(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('Cetak_bkp/edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
			$('[name="JUMLAH_SKPD"]').val(data.JUMLAH_OBYEK);
			$('[name="TGL_PERMOHONAN"]').val(data.TGL_PERMOHONAN);
            $('[name="PAJAK_POKOK"]').val(data.PAJAK_POKOK);
      
            $('#modal_form').modal('show'); // show bootstrap modal when complete loaded
            $('.modal-title').text('STS'); // Set title to Bootstrap modal title
...
function save(id)
{
	...
	var url;
	  ...
	  if(save_method == 'add') {
        ...
        url = "<?php echo site_url('Cetak_bkp/generate_excel/')?>" + id;
    }
	  ...
	  $.ajax({
        ...
        error: function (jqXHR, textStatus, errorThrown) {
            alert('Error triggering generate_excel');
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Sts Form</h3>
            </div>
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    <input type="hidden" value="" name="PAJAK_POKOK"/> 
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">JUMLAH OBYEK</label>
                            <div class="col-md-9">
                                <input name="JUMLAH_SKPD" placeholder="NO FORMULIR" class="form-control" type="text" readonly>
                                <span class="help-block"></span>
                            </div>
                        </div>

						<div class="form-group">
                            <label class="control-label col-md-3">TGL PERMOHONAN</label>
                            <div class="col-md-9">
                                <input name="TGL_PERMOHONAN" placeholder="NO FORMULIR" class="form-control" type="text" readonly>
                                <span class="help-block"></span>
                            </div>
                        </div>

						<div class="form-group">
                            <label class="control-label col-md-3">PAJAK POKOK</label>
                            <div class="col-md-9">
                                <input name="PAJAK_POKOK" placeholder="NO FORMULIR" class="form-control" type="text" readonly>
                                <span class="help-block"></span>
                            </div>
                        </div>
            ...
            <div class="modal-footer">
			<a href="<?php echo base_url('Cetak_bkp/generate_excel/' . $id); ?>" class="btn btn-primary">Download Excel</a>
