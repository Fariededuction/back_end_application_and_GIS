...
<script>
  $('.shawCalRanges').daterangepicker({
        ...
        $('#btn-filter').click(function() { //button filter event click
            view.ajax.reload(); //just reload table
        });
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //datatables
        view = $('#table-siswa-tabungan').DataTable({
           ...
           "lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],
            ...
            "ajax": {
                "url": "<?php echo site_url('Insidentil_tunggakan/tunggakan') ?>",
                "type": "POST",
               "data": function(data) {
    ...
    function reload_table() {
        view.ajax.reload(null, false); //reload datatable ajax 
    }
});
