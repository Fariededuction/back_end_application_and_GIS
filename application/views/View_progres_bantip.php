            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div >
                        ...
                        <a href="<?php echo site_url('Progres_bantip/importBantip1')?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
...
<p class="card-text">Total Obyek Yang bantip :</p>
<a href="#"  class="btn btn-primary"><?php echo $totalban;?></a>
</div>
</div>
</div>
...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="col-md-12 col-md-6 col-lg-9">
                <form class="mt-3" method="post" id="form">
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <button class="btn btn-default" type="button">Pilih Tanggal Berakhir</button>
                        </div>
                    ...
                    <table class="table table-bordered table-striped nowrap display" width="50%" cellspacing="0" id="table-progres">
                        <thead>
                         ...
                         <!--       <th class="border-0 text-center">TGL BAYAR</th> -->
                                <th class="border-0 text-center">NO FORM</th>
                                <th class="border-0 text-center">TGL AKHIR BERLAKU</th>
								<th class="border-0 text-center">TGL BANTIP</th>
    ...
    $(document).ready(function() {	
        ...
        table_m = $('#table-progres').DataTable({
           ...
           "lengthMenu": [[10, 25, 50, -1], [10, 25, 50, "All"]],
            ...
            "ajax": {
                "url": "<?php echo site_url('Progres_bantip/progres_bantip')?>",
                "type": "POST",
				"data": function ( data ) {
