    ...
    <div class="col-md-9">
        <div class="card">
            <div class="card-header">
                ...
                <h4 class="card-title mb-0"> DATA PENERTIBAN BADAN</h4>
            </div>
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="col-md-12 col-md-6 col-lg-6">
                <form class="mt-3" method="post" id="form1">
            ...
            <div class="card-body ">
                <div class="table-responsive no-wrap">
                    <table class="table table-bordered table-striped nowrap display" width="80%" cellspacing="0" id="table-progres">
                        <thead>
                            <tr>                           
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        //datatables
tabel_m = $('#table-progres').DataTable({
            ...
            "ajax": {
                "url": baseurl+"Progres_silang/progres_silang",
                "type": "POST",
				"data": function ( data ) {
        ...
        $('#btn-filter').click(function() { //button filter event click
            tabel_m.ajax.reload(); //just reload table
        });
...
{
    tabel_m.ajax.reload(null,false); //reload datatable ajax 
}
